...
export class AboutUsComponent {
  description: string =
    'LISSAPPV was created specially for help you to study different aspects of subject area' +
  ...
  team: InfoTeammate[] = [
    {
      ...
      description:
        'Daniil is a Kotlin developer. He likes reading books and jokes about ballers.' +
    ...
    },
    {
      ...
      description:
        'Dmitry Zayats is a C# developer. He likes jokes about patsany full rush B and cross fires.' +
    ...
    },
    {
      ...
      description:
        'Denis Koltovich is a back-end developer. He is like a kitty in our team.' +
    ...
    },
    {
      ...
      description:
        'Alexander is a front-end developer. To our little happiness and big regrets we have such' +
    ...
    },
    {
      ...
      description:
        'This is the person who wrote this text. So, he doesn’t know what to write here,' +
    ...
    },
    {
      ...
      description:
        'Vladislav is a Back-end developer. He LIKES Python and it’s libraries VERY MUCH so' +
